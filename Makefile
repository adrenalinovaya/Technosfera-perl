...
TO_INST_PM = lib/Local/DataSorter.pm \
	lib/Local/LineReader 1.pm \
	lib/Local/LineReader 2.pm \
	lib/Local/LineReader.pm \
	lib/Local/MusicLibrary.pm \
	lib/Local/TableMaker.pm

PM_TO_BLIB = lib/Local/DataSorter.pm \
	blib\lib\Local\DataSorter.pm \
	lib/Local/LineReader 1.pm \
	blib\lib\Local\LineReader 1.pm \
	lib/Local/LineReader 2.pm \
	blib\lib\Local\LineReader 2.pm \
	lib/Local/LineReader.pm \
	blib\lib\Local\LineReader.pm \
	lib/Local/MusicLibrary.pm \
	blib\lib\Local\MusicLibrary.pm \
	lib/Local/TableMaker.pm \
	blib\lib\Local\TableMaker.pm
...
Iterator.def: Makefile.PL
	$(PERLRUN) -MExtUtils::Mksymlists \
     -e "Mksymlists('NAME'=>\"Local::Iterator\", 'DLBASE' => '$(BASEEXT)', 'DL_FUNCS' => {  }, 'FUNCLIST' => [], 'IMPORTS' => {  }, 'DL_VARS' => []);"
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e "pm_to_blib({{@ARGV}}, '$(INST_LIB)\auto', q[$(PM_FILTER)], '$(PERM_DIR)')" -- \
	  lib/Local/DataSorter.pm blib\lib\Local\DataSorter.pm \
	  lib/Local/LineReader 1.pm blib\lib\Local\LineReader 1.pm \
	  lib/Local/LineReader 2.pm blib\lib\Local\LineReader 2.pm \
	  lib/Local/LineReader.pm blib\lib\Local\LineReader.pm \
	  lib/Local/MusicLibrary.pm blib\lib\Local\MusicLibrary.pm \
	  lib/Local/TableMaker.pm blib\lib\Local\TableMaker.pm 
